...
//    }
    ...
    public void periodic() {
        _frame.setVelocity(1);
        _frame.setOmega(0.1);
        _frame.setYaw(_imu.getYaw());
        _proxy.sendData(_frame);
...
//        _indexer.startAgitator();
    ...
    @Override
    public Pose getPose() {
        return null;//RobotPose(_driveTrain.getDrivePose(), _turret.getPose());
    }
